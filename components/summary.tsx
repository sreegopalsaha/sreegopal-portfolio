...
function Summary() {
  return (
    <header className="">
      ...
      <div className="flex flex-wrap items-center gap-2 text-base font-medium mb-3">
      ...
      <p className="text-base leading-relaxed text-muted-foreground ">
        ...
        solutions. Through problem-solving and API development, I craft systems
        that serve real user needs.
      </p>
    </header>
  );
}
